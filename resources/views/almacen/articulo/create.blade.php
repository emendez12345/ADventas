...
@section ('contenido')
	...
	<div class="row">
		...
		<div class="form-group">
            	...
            	<input type="text" name="codigo"require value="{{old('codigo')}}" class="form-control" placeholder="Codigo...">
            </div>
		</div>
		<div class="col-lg-6 col-sm-6 col-xs-12">
		<div class="form-group">
            	<label for="stock">Stock</label>
            	<input type="text" name="stock"require value="{{old('stock')}}" class="form-control" placeholder="Stock...">
            </div>
		</div>
